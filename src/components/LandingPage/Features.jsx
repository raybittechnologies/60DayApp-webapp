...
const FeatureLabel = ({ text }) => (
  <span className="inline-flex w-fit items-center justify-center text-[18px] sm:text-[18px] font-[400] text-white bg-[#C03A10] rounded-full px-6 py-2 whitespace-nowrap">
    {text}
  </span>
);

const Tag = ({ text }) => (
  <span className="flex items-center gap-1.5 px-2 py-1 bg-[#FFCAB2] rounded-[4px] text-[18px] sm:text-[18px] md:text-[18px] leading-[1.5] font-[400] text-[#C03A10]">
    <span className="w-[12px] h-[12px] rounded-full bg-[#C03A10] shrink-0" />
    {text}
  </span>
);
