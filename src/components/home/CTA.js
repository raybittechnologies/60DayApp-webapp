...
export default function CTA() {
  ...
  return (
    ...
    <section className="section-outer relative pt-[10px] pb-[20px] sm:pb-[32px] lg:pb-[40px]">
              ...
              <div className="w-full max-w-[546px] bg-white rounded-[24px] p-[20px] sm:p-[32px] md:p-[40px] shadow-[0_16px_48px_rgba(200,100,50,0.08)] border border-[#FF8055]/20">
                <div className="flex flex-col gap-[12px] sm:gap-[14px]">
                  ...
                  <div className="relative">
                    ...
                    <input suppressHydrationWarning type="text" placeholder="Enter your name" className="w-full h-[48px] sm:h-[52px] pl-[42px] pr-[16px] rounded-[10px] border border-[#FF8055] focus:outline-none focus:border-[#FA6A31] font-body text-[15px] sm:text-[16px] text-[#000000] placeholder-[#000000]" />
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <input suppressHydrationWarning type="email" placeholder="Enter your email" className="w-full h-[48px] sm:h-[52px] pl-[42px] pr-[16px] rounded-[10px] border border-[#FF8055] focus:outline-none focus:border-[#FA6A31] font-body text-[15px] sm:text-[16px] text-[#000000] placeholder-[#000000]" />
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <select suppressHydrationWarning className="w-full h-[48px] sm:h-[52px] pl-[42px] pr-[16px] rounded-[10px] border border-[#FF8055] focus:outline-none focus:border-[#FA6A31] font-body text-[15px] sm:text-[16px] text-[#000000] appearance-none bg-white cursor-pointer">
