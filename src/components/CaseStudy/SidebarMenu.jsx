...
//       <div className="hidden lg:flex flex-col sticky top-[100px] gap-[32px]">
...
//                 <button 
//                   onClick={() => setActiveTab(item)}
//                   className={`font-body font-semibold text-[16px] tracking-tight transition-colors text-left ${activeTab === item ? 'text-[#1A1A1A]' : 'text-[#1A1A1A] hover:text-[#F05A28]'}`}
//                 >
//                   {item}
//                 </button>
//               </li>
