...
import { slideLeft, fadeUp, staggerContainer, staggerItem, viewport } from '@/utils/motionVariants';
  ...
  return (
    <div className="section-outer bg-transparent">
      ...
      >
        ...
        {/* Paragraphs */}
        <motion.div
          className="space-y-5 sm:space-y-6 text-[#1A1A1A] text-[14px] sm:text-[15px] md:text-[20px] leading-[1.85]"
