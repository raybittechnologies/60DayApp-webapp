...
import { scaleUp, staggerContainer, staggerItem, viewport } from '@/utils/motionVariants';
    ...
    <div className="section-outer py-8 sm:py-10 bg-transparent">
      <div className="section-inner">
        ...
        >
          ...
          >
            <motion.h2
              className="font-heading font-bold text-[22px] sm:text-[32px] md:text-[40px] text-[#1A1A1A] tracking-tight leading-tight"
            ...
            <motion.p
              className="font-body text-[13px] sm:text-[15px] font-medium text-[#555555]"
              variants={staggerItem}
            >
          ...
          <motion.div
            className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto"
            variants={staggerItem}
          >
