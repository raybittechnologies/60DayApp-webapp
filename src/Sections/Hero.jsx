...
export default function Hero() {
  return (
    <section className="
      ...
      pt-[100px] sm:pt-[120px] lg:pt-0
      lg:min-h-[815px]
      px-4 sm:px-8 lg:px-[80px]
    ">

      {/* ── WHITE CARD ── */}
      <div className="
        relative lg:absolute lg:top-[135px]
        w-full lg:w-[calc(100%-160px)] xl:max-w-[1280px]
        bg-white
      ...
      ">
        ...
        <div className="
          hidden lg:block
          relative flex-none self-center
          lg:w-[458px] lg:h-[600px]
        ">
          <img
            src={HeroMockup}
            alt="App Mockup"
      ...
      {/* Spacer so section has height on desktop (card is absolute) */}
      <div className="hidden lg:block w-full" style={{ height: 815 }} />
    </section>
  );
}