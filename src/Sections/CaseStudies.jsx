...
const CaseStudyCard = ({ tagLabel, badgeTime, title, desc, stat1, stat2, stat3, pills, mockupGroup }) => (
  <div className="group relative w-full bg-[#FFF3EE] border-[1px] border-[#FFCAB2] shadow-[0_4px_16px_rgba(200,100,50,0.06)] rounded-[32px] p-[16px] flex flex-col transition-all duration-300 hover:shadow-[0_12px_40px_rgba(200,100,50,0.12)]">
    ...
    <div className="relative w-full h-[200px] sm:h-[240px] md:h-[260px] bg-gradient-to-br from-white to-[#FAFAFA] rounded-[24px] shadow-sm overflow-hidden border border-white">
      ...
      >
        ...
        <span className="font-heading font-[400] text-[#F05A28] text-[12px] sm:text-[14px] tracking-tight">{tagLabel}</span>
      </div>

      <div className="absolute top-[12px] sm:top-[16px] right-[12px] sm:right-[16px] flex flex-col items-center justify-center px-[10px] sm:px-[12px] py-[6px] sm:py-[8px] bg-gradient-to-b from-[#C03A10] to-[#AE330B] border border-[#FF8055] rounded-[6px] shadow-md z-30 text-center leading-[1.1]">
        <span className="font-[400] text-white text-[13px] sm:text-[16px] tracking-tight">{badgeTime}</span>
        <span className="font-[400] text-white text-[13px] sm:text-[16px] uppercase mt-[3px] sm:mt-[4px] tracking-tight">Delivered</span>
      </div>
    ...
    <div className="flex flex-col flex-grow pt-[4px]">
      <h3 className="font-heading font-[600] text-[18px] sm:text-[20px] text-[#C03A10] mt-[16px] sm:mt-[20px] px-[8px] tracking-tight">{title}</h3>
      <p className="font-body text-[14px] sm:text-[16px] font-[400] leading-[1.6] text-[#1A1A1A] mt-[8px] px-[8px] min-h-[56px] sm:min-h-[60px]">{desc}</p>
      ...
      <div className="flex items-center justify-between px-[8px] pb-[8px]">
        <div className="flex flex-col flex-1">
          <span className="font-heading font-[600] text-[22px] sm:text-[28px] text-[#F05A28] leading-none tracking-tight">{stat1.value}</span>
          <span className="font-body font-[400] text-[12px] sm:text-[14px] text-[#1A1A1A] mt-[4px] leading-[1.2] max-w-[60px]">{stat1.label}</span>
        </div>
        <div className="w-[2px] h-[36px] bg-[#DE8662]/20 mx-[6px] sm:mx-[8px] lg:mx-[16px]" />
        <div className="flex flex-col flex-1">
          <span className="font-heading font-[600] text-[22px] sm:text-[28px] text-[#F05A28] leading-none tracking-tight">{stat2.value}</span>
          <span className="font-body font-[400] text-[12px] sm:text-[14px] text-[#1A1A1A] mt-[4px] leading-[1.2] max-w-[60px]">{stat2.label}</span>
        </div>
        <div className="w-[2px] h-[36px] bg-[#DE8662]/20 mx-[6px] sm:mx-[8px] lg:mx-[16px]" />
        <div className="flex flex-col flex-1">
          <div className="flex items-center gap-[2px]">
            <span className="font-heading font-[600] text-[22px] sm:text-[28px] text-[#F05A28] leading-none tracking-tight">{stat3.value}</span>
            {stat3.icon && (
          ...
          <span className="font-body font-[400] text-[12px] sm:text-[14px] text-[#1A1A1A] mt-[4px] leading-[1.2] max-w-[60px]">{stat3.label}</span>
        </div>
        <div className="flex flex-col gap-[5px] sm:gap-[6px] items-end shrink-0 ml-[6px] sm:ml-[8px] xl:ml-[16px]">
          {pills.map((p, i) => (
            <div key={i} className="bg-[#FFCAB2] text-[#C03A10] px-[8px] sm:px-[10px] py-[3px] sm:py-[4px] rounded-[4px] font-heading font-[400] text-[10px] sm:text-[11px] xl:text-[12px] whitespace-nowrap border border-[#F7BFAF]/50">{p}</div>
          ))}
        </div>
      </div>
    </div>
...
export default function CaseStudies() {
  ...
  return (
    <section className="relative w-full bg-soft-gray flex justify-center items-start pt-[20px] pb-[40px] sm:pb-[60px] px-[16px] sm:px-[40px] md:px-[80px] overflow-hidden">
